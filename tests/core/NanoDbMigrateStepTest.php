...
class NanoMigrate_StepTest extends PHPUnit_Framework_TestCase {
	...
	public function testEmptyFolder() {
		...
		$this->assertType('Nano_Migrate_ScriptEmpty', $step->getScript());
	}
	...
	public function testManualOnly() {
		...
		$this->assertEquals(0, count($step->getQueries()));
		$this->assertType('Nano_Migrate_Script', $step->getScript());
		$this->assertType('Nano_Migrate_Script_03_script', $step->getScript());
	}
	...
	public function testBothUpdates() {
		...
		$this->assertEquals(10, count($step->getQueries()));
		$this->assertType('Nano_Migrate_Script', $step->getScript());
		$this->assertType('Nano_Migrate_Script_04_both', $step->getScript());
	}
